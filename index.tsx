...
import reader01Before from "@/assets/reader-01-before.jpg";
import reader01After from "@/assets/reader-01-after.jpg";
import reader02 from "@/assets/reader-02.jpg";
import reader03 from "@/assets/reader-03.jpg";
import reader04Before from "@/assets/reader-04-before.jpg";
import reader04After from "@/assets/reader-04-after.jpg";

import { chapters, faqs, testimonials } from "@/components/site/data";

const STRIPE_PAYMENT_LINK = "https://buy.stripe.com/eVq6oA2hHfvH8Yjeo1cZa01";
...
const readerCases: { title: string; note: string; shots: Shot[] }[] = [
  {
    ...
    shots: [
      { label: "Before", src: reader01Before, alt: "Reader 01 trading journal calendar before applying the process" },
      { label: "After", src: reader01After, alt: "Reader 01 trading journal calendar after applying the process" },
    ],
  },
  {
    title: "Reader 02",
    note: "P&L by asset class shared after study",
    shots: [{ src: reader02, alt: "Reader 02 profit and loss by asset class" }],
  },
  {
    title: "Reader 03",
    note: "Daily P&L shared after applying the process",
    shots: [{ src: reader03, alt: "Reader 03 daily profit and loss chart" }],
  },
  {
    title: "Reader 04",
    note: "Trade history before and after structured entries",
    shots: [
      { label: "Before", src: reader04Before, alt: "Reader 04 trade history before applying the system" },
      { label: "After", src: reader04After, alt: "Reader 04 trade history after applying the system" },
    ],
  },
];
    ...
    <main className="overflow-x-hidden">
      ...
      <header className="sticky top-0 z-40 border-b border-border bg-background/80 backdrop-blur-xl">
        <div className="mx-auto grid max-w-7xl grid-cols-[minmax(0,1fr)_auto] items-center gap-4 px-5 py-4 sm:px-8">
          ...
          <a href={STRIPE_PAYMENT_LINK} target="_self" rel="noopener noreferrer" className="btn-gold !px-5 !py-3">
            Buy — $55
          </a>
        </div>
      </header>
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-14 px-5 py-16 sm:px-8 lg:grid-cols-2 lg:py-24">
          ...
          <div>
            ...
            <div className="mt-8 flex flex-col gap-3">
              <a href={STRIPE_PAYMENT_LINK} target="_self" rel="noopener noreferrer" className="btn-gold w-full">
                Buy the book
              </a>
      ...
      <section id="buy" className="relative isolate overflow-hidden border-t border-border bg-ink">
        ...
        <div className="mx-auto grid max-w-6xl items-center gap-12 px-5 py-24 sm:px-8 lg:grid-cols-[0.8fr_1fr]">
          ...
          <div>
            ...
            <a href={STRIPE_PAYMENT_LINK} target="_self" rel="noopener noreferrer" className="btn-gold mt-8 w-full sm:w-auto">
        ...
        <div className="mx-auto max-w-7xl px-5 py-12 sm:px-8">
          <div className="grid gap-8 sm:grid-cols-[1fr_auto] sm:items-end">
            ...
            <nav className="flex flex-wrap gap-x-6 gap-y-2 text-xs tracking-[0.18em] text-muted-foreground uppercase">
              ...
              <a href={STRIPE_PAYMENT_LINK} target="_self" rel="noopener noreferrer" className="hover:text-gold">
                Buy
              </a>
            </nav>
          </div>
